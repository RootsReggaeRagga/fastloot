...
$(function() {
    ...
    $('#pnotify-desktop-default').on('click', function () {
        ...
        (new PNotify({
            ...
            desktop: {
                desktop: true,
                addclass: 'bg-green',
                icon: 'assets/images/pnotify/default.png'/*tpa=http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/images/pnotify/default.png*/
            }
        })
    ...
    $('#pnotify-desktop-danger').on('click', function () {
        ...
        (new PNotify({
            ...
            desktop: {
                desktop: true,
                icon: 'assets/images/pnotify/danger.png'/*tpa=http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/images/pnotify/danger.png*/
            }
        })
        ).get().click(function(e) {
            if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
    ...
    $('#pnotify-desktop-success').on('click', function () {
        ...
        (new PNotify({
            ...
            desktop: {
                desktop: true,
                icon: 'assets/images/pnotify/success.png'/*tpa=http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/images/pnotify/success.png*/
            }
        })
        ).get().click(function(e) {
            if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
    ...
    $('#pnotify-desktop-warning').on('click', function () {
        ...
        (new PNotify({
            ...
            desktop: {
                desktop: true,
                icon: 'assets/images/pnotify/warning.png'/*tpa=http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/images/pnotify/warning.png*/
            }
        })
        ).get().click(function(e) {
            if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
    ...
    $('#pnotify-desktop-info').on('click', function () {
        ...
        (new PNotify({
            ...
            desktop: {
                desktop: true,
                icon: 'assets/images/pnotify/info.png'/*tpa=http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/images/pnotify/info.png*/
            }
        })
        ).get().click(function(e) {
            if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
