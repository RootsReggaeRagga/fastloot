...
$(function() {
    ...
    // Add sample data
    var people = [
        {id: 1, name: {first: 'Joe', last: 'Fabiano'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/Joe.Fabiano@ex.com'},
        {id: 2, name: {first: 'Fred', last: 'Wecler'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/Fred.Wecler@ex.com'},
        {id: 3, name: {first: 'Steve', last: 'Wilson'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/Steve.Wilson@ex.com'},
        {id: 4, name: {first: 'Maria', last: 'Fernandez'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/M.Fernandez@ex.com'},
        {id: 5, name: {first: 'Pierre', last: 'Barbault'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/Pierre.Barbault@ex.com'},
        {id: 6, name: {first: 'Nancy', last: 'Moore'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/Nancy.Moore@ex.com'},
        {id: 7, name: {first: 'Barbara', last: 'MacDonald'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/B.MacDonald@ex.com'},
        {id: 8, name: {first: 'Wilma', last: 'Williams'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/Wilma.Williams@ex.com'},
        {id: 9, name: {first: 'Sasha', last: 'Silver'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/Sasha.Silver@ex.com'},
        {id: 10, name: {first: 'Don', last: 'Pérignon'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/Don.Pérignon@ex.com'},
        {id: 11, name: {first: 'Aaron', last: 'Kinley'}, ip: '0.0.0.1', email: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/Aaron.Kinley@ex.com'}
    ];
    ...
    var hot_validation_init = new Handsontable(hot_validation, {
        ...
        beforeChange: function (changes, source) {
            for (var i = changes.length - 1; i >= 0; i--) {
                ...
                else if ((changes[i][1] === 'name.first' || changes[i][1] === 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/name.last') && changes[i][3].charAt(0)) {
        ...
        columns: [
            ...
            {data: 'name.first'},
            {data: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/name.last'},
