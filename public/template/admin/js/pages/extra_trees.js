...
$(function() {
    ...
    $(".tree-ajax").fancytree({
        source: {
            url: "http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/demo_data/fancytree/fancytree.json"
        },
        init: function(event, data) {
            $('.has-tooltip .fancytree-title').tooltip();
        }
    ...
    $(".tree-table").fancytree({
        ...
        lazyLoad: function(event, data) {
            data.result = {url: "http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/ajax-sub2.json"}
        },
