        ...
        columns: [
            {
                ...
                source: function (query, process) {
                    $.ajax({
                        url: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/demo_data/handsontable/cars.json',
                        dataType: 'json',
                        data: {
                            query: query
                        },
            ...
            },
            {
                ...
                source: function (query, process) {
                    $.ajax({
                        url: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/demo_data/handsontable/colors.json',
                        dataType: 'json',
                        data: {
                            query: query
                        },
