...
$(function() {
    ...
    $(".file-uploader").pluploadQueue({
        ...
        url: 'http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/demo_data/uploader/plupload.json',
        chunk_size: '300Kb',
        unique_names: true,
        filters: {
            max_file_size: '300Kb',
    ...
    $(".flash-uploader").pluploadQueue({
        ...
        // Flash settings
        flash_swf_url: 'assets/js/plugins/uploaders/plupload/files/Moxie.swf'/*tpa=http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/js/plugins/uploaders/plupload/files/Moxie.swf*/
    });
    ...
    $(".uploader-events").pluploadQueue({
        ...
        // Flash settings
        flash_swf_url: '../../../../../../../plupload/js/Moxie.swf'/*tpa=http://demo.interface.club/plupload/js/Moxie.swf*/,

        // Silverlight settings
        silverlight_xap_url: 'http://demo.interface.club/plupload/js/Moxie.xap',
