...
$(function() {
    ...
    $(".datepicker-icon").datepicker({
        showOn: "button",
        buttonImage: "assets/images/ui/datepicker_trigger.png"/*tpa=http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/images/ui/datepicker_trigger.png*/,
    ...
    $("#ac-remote").autocomplete({
        minLength: 2,
        source: "http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/demo_data/jquery_ui/autocomplete.php",
        search: function() {
    ...
    $("#ac-caching").autocomplete({
        ...
        source: function(request, response) {
            ...
            $.getJSON("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/pages/assets/demo_data/jquery_ui/autocomplete.php", request, function(data, status, xhr) {
                cache[ term ] = data;
                response(data);
            });
        },
