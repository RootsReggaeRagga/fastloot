...
$(function () {
    ...
    function barVertical(element, height) {
        ...
        // Format data
        var format = d3.format("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/charts/d3/bars/,.0f");
        ...
        d3.csv("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/charts/d3/bars/assets/demo_data/d3/bars/bars_horizontal.csv", function(data) {
