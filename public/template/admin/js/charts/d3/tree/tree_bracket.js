...
$(function () {
    ...
    function brackets(element, height) {
        ...
        d3.json("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/charts/d3/tree/assets/demo_data/d3/tree/tree_bracket.json", function(json) {
            root = json;
            root.x0 = height / 2;
            root.y0 = width / 2;
        ...
        function update(source) {
            ...
            // Update the nodes…
            var node = svg.selectAll("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/charts/d3/tree/g.node")
            ...
            // Update the links
            var link = svg.selectAll("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/charts/d3/tree/path.link")
