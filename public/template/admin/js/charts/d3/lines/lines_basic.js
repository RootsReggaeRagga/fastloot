...
$(function () {
    ...
    function lineBasic(element, height) {
        ...
        var parseDate = d3.time.format("%d-%b-%y").parse,
            ...
            formatValue = d3.format("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/charts/d3/lines/,.2f"),
        ...
        d3.tsv("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/charts/d3/lines/assets/demo_data/d3/lines/lines_basic.tsv", function(error, data) {
