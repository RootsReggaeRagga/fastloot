...
$(function () {
    ...
    function sunburstZoomable(element, width, height) {
        ...
        d3.json("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/charts/d3/sunburst/assets/demo_data/d3/sunburst/sunburst_basic.json", function(error, root) {
            node = root;
