    ...
    Wysihtml5.prototype = {
        ...
        initHtml: function(toolbar) {
            ...
            toolbar.find(changeViewSelector).click(function(e) {
                toolbar.find('http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/editors/wysihtml5/a.btn').not(changeViewSelector).toggleClass('disabled');
            });
        },
