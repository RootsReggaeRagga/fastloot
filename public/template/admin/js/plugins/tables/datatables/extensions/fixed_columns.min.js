...
*/
(function(d){"function"===typeof define&&define.amd?define(["jquery","http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/datatables.net"],function(q){return d(q,window,document)}):"object"===typeof exports?module.exports=function(q,r){q||(q=window);if(!r||!r.fn.dataTable)r=require("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/datatables.net")(q,r).$;return d(r,q,q.document)}:d(jQuery,window,document)})(function(d,q,r,t){var s=d.fn.dataTable,u,m=function(a,b){var c=this;if(this instanceof m){if(b===t||!0===b)b={};var e=d.fn.dataTable.camelToHungarian;e&&(e(m.defaults,m.defaults,!0),e(m.defaults,
...
this.dom.grid.dt)[0];this._fnColCalc();this._fnGridSetup();var c,e=!1;d(this.s.dt.nTableWrapper).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/mousedown.DTFC",function(){e=!0;d(r).one("mouseup",function(){e=!1})});d(this.dom.scroller).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/mouseover.DTFC touchstart.DTFC",function(){e||(c="main")}).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/scroll.DTFC",function(a){!c&&a.originalEvent&&(c="main");if("main"===c&&(0<b.s.iLeftColumns&&(b.dom.grid.left.liner.scrollTop=b.dom.scroller.scrollTop),0<b.s.iRightColumns))b.dom.grid.right.liner.scrollTop=b.dom.scroller.scrollTop});var f="onwheel"in
r.createElement("div")?"http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/wheel.DTFC":"http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/mousewheel.DTFC";if(0<b.s.iLeftColumns)d(b.dom.grid.left.liner).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/mouseover.DTFC touchstart.DTFC",function(){e||(c="left")}).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/scroll.DTFC",function(a){!c&&a.originalEvent&&(c="left");"left"===c&&(b.dom.scroller.scrollTop=b.dom.grid.left.liner.scrollTop,0<b.s.iRightColumns&&(b.dom.grid.right.liner.scrollTop=b.dom.grid.left.liner.scrollTop))}).on(f,function(a){b.dom.scroller.scrollLeft-="wheel"===a.type?-a.originalEvent.deltaX:a.originalEvent.wheelDeltaX});
if(0<b.s.iRightColumns)d(b.dom.grid.right.liner).on("mouseover.DTFC touchstart.DTFC",function(){e||(c="right")}).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/scroll.DTFC",function(a){!c&&a.originalEvent&&(c="right");"right"===c&&(b.dom.scroller.scrollTop=b.dom.grid.right.liner.scrollTop,0<b.s.iLeftColumns&&(b.dom.grid.left.liner.scrollTop=b.dom.grid.right.liner.scrollTop))}).on(f,function(a){b.dom.scroller.scrollLeft-="wheel"===a.type?-a.originalEvent.deltaX:a.originalEvent.wheelDeltaX});d(q).on("resize.DTFC",function(){b._fnGridLayout.call(b)});
var g=!0,h=d(this.s.dt.nTable);h.on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/draw.dt.DTFC",function(){b._fnColCalc();b._fnDraw.call(b,g);g=!1}).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/column-sizing.dt.DTFC",function(){b._fnColCalc();b._fnGridLayout(b)}).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/column-visibility.dt.DTFC",function(a,c,d,e,f){if(f===t||f)b._fnColCalc(),b._fnGridLayout(b),b._fnDraw(!0)}).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/select.dt.DTFC deselect.dt.DTFC",function(){b._fnDraw(!1)}).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/destroy.dt.DTFC",function(){h.off(".DTFC");d(b.dom.scroller).off(".DTFC");d(q).off(".DTFC");d(this.s.dt.nTableWrapper).off(".DTFC");d(b.dom.grid.left.liner).off(".DTFC "+
...
null!==this.s.fnDrawCallback&&this.s.fnDrawCallback.call(this,this.dom.clone.left,this.dom.clone.right);d(this).trigger("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/draw.dtfc",{leftClone:this.dom.clone.left,rightClone:this.dom.clone.right})},_fnCloneRight:function(a){if(!(0>=this.s.iRightColumns)){var b,c=[];for(b=this.s.iTableColumns-this.s.iRightColumns;b<this.s.iTableColumns;b++)this.s.dt.aoColumns[b].bVisible&&c.push(b);this._fnClone(this.dom.clone.right,this.dom.grid.right,c,a)}},_fnCloneLeft:function(a){if(!(0>=this.s.iLeftColumns)){var b,
