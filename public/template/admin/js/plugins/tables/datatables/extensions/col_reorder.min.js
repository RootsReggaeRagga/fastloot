...
*/
(function(f){"function"===typeof define&&define.amd?define(["jquery","http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/datatables.net"],function(n){return f(n,window,document)}):"object"===typeof exports?module.exports=function(n,k){n||(n=window);if(!k||!k.fn.dataTable)k=require("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/datatables.net")(n,k).$;return f(k,n,n.document)}:f(jQuery,window,document)})(function(f,n,k,r){function p(a){for(var c=[],d=0,e=a.length;d<e;d++)c[a[d]]=d;return c}function o(a,c,d){c=a.splice(c,1)[0];a.splice(d,0,c)}function q(a,c,d){for(var e=[],b=0,f=a.childNodes.length;b<
...
b=0;for(g=k;b<g;b++)f(a.aoColumns[b].nTh).off("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/click.DT"),this.oApi._fnSortAttachListener(a,a.aoColumns[b].nTh,b);f(a.oInstance).trigger("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/column-reorder.dt",[a,{from:c,to:d,mapping:m,drop:e,iFrom:c,iTo:d,aiInvertMapping:m}])}};var h=function(a,c){var d=(new f.fn.dataTable.Api(a)).settings()[0];if(d._colReorder)return d._colReorder;!0===c&&(c={});var e=f.fn.dataTable.camelToHungarian;e&&(e(h.defaults,h.defaults,!0),e(h.defaults,c||{}));this.s={dt:null,init:f.extend(!0,{},h.defaults,c),fixed:0,fixedRight:0,
