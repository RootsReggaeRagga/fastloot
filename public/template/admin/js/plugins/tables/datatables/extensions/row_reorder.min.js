...
*/
(function(e){"function"===typeof define&&define.amd?define(["jquery","http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/datatables.net"],function(f){return e(f,window,document)}):"object"===typeof exports?module.exports=function(f,g){f||(f=window);if(!g||!g.fn.dataTable)g=require("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/datatables.net")(f,g).$;return e(g,f,f.document)}:e(jQuery,window,document)})(function(e,f,g){var j=e.fn.dataTable,i=function(b,a){if(!j.versionCheck||!j.versionCheck("1.10.8"))throw"DataTables RowReorder requires DataTables 1.10.8 or newer";this.c=e.extend(!0,{},j.defaults.rowReorder,
...
snapX:!1,update:!0};i.version="1.1.1";e.fn.dataTable.RowReorder=i;e.fn.DataTable.RowReorder=i;e(g).on("http://demo.interface.club/limitless/layout_4/LTR/default/assets/js/plugins/tables/datatables/extensions/init.dt.dtr",function(b,a){if("dt"===b.namespace){var c=a.oInit.rowReorder,d=j.defaults.rowReorder;if(c||d)d=e.extend({},c,d),!1!==c&&new i(a,d)}});return i});
